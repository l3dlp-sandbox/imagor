...
The benchmark summary on this page is based on the committed AWS EC2 `c7i.large` rerun documented in the [benchmark results](https://github.com/cshum/image-servers-benchmark/tree/master/results). On this benchmark set, imagor 1.9.1 is consistently faster than thumbor overall and competitive with imgproxy.
